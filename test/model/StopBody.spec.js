...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelemetryApi.StopBody();
  });
  ...
  describe('StopBody', function() {
    it('should create an instance of StopBody', function() {
      // uncomment below and update the code to test StopBody
      //var instane = new TelemetryApi.StopBody();
      //expect(instance).to.be.a(TelemetryApi.StopBody);
    });
    ...
    it('should have the property telemetryId (base name: "telemetryId")', function() {
      ...
      //var instance = new TelemetryApi.StopBody();
