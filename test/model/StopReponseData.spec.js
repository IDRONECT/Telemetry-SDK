...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelemetryApi.StopReponseData();
  });
  ...
  describe('StopReponseData', function() {
    it('should create an instance of StopReponseData', function() {
      // uncomment below and update the code to test StopReponseData
      //var instane = new TelemetryApi.StopReponseData();
      //expect(instance).to.be.a(TelemetryApi.StopReponseData);
    });

    it('should have the property flightId (base name: "flightId")', function() {
      // uncomment below and update the code to test the property flightId
      //var instance = new TelemetryApi.StopReponseData();
