...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelemetryApi.StartBody();
  });
  ...
  describe('StartBody', function() {
    it('should create an instance of StartBody', function() {
      // uncomment below and update the code to test StartBody
      //var instane = new TelemetryApi.StartBody();
      //expect(instance).to.be.a(TelemetryApi.StartBody);
    });
    ...
    it('should have the property aircraftId (base name: "aircraftId")', function() {
      ...
      //var instance = new TelemetryApi.StartBody();
