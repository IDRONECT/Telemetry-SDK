...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://telemetry.idronect.com/v1
         */
        this.basePath = 'https://telemetry.idronect.com/v1'.replace(/\/+$/, '');
        ...
        this.authentications = {
            'SECRET': {type: 'apiKey', 'in': 'header', name: 'Authorization'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/TEL-1.2.5/Javascript'
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://telemetry.idronect.com/v1",
              'description': "No description provided",
            },
            {
              'url': "http://telemetry.idronect.com/v1",
              'description': "No description provided",
            }
      ];
    }
