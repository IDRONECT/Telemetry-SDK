...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelemetryApi.DataResponse();
  });
  ...
  describe('DataResponse', function() {
    it('should create an instance of DataResponse', function() {
      ...
      //var instane = new TelemetryApi.DataResponse();
      //expect(instance).to.be.a(TelemetryApi.DataResponse);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new TelemetryApi.DataResponse();
