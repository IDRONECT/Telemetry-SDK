...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelemetryApi.DataResponseData();
  });
  ...
  describe('DataResponseData', function() {
    it('should create an instance of DataResponseData', function() {
      ...
      //var instane = new TelemetryApi.DataResponseData();
      //expect(instance).to.be.a(TelemetryApi.DataResponseData);
    });
    ...
    it('should have the property flightId (base name: "flightId")', function() {
      ...
      //var instance = new TelemetryApi.DataResponseData();
