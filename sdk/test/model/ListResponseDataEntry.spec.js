...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelemetryApi.ListResponseDataEntry();
  });
  ...
  describe('ListResponseDataEntry', function() {
    it('should create an instance of ListResponseDataEntry', function() {
      // uncomment below and update the code to test ListResponseDataEntry
      //var instane = new TelemetryApi.ListResponseDataEntry();
      //expect(instance).to.be.a(TelemetryApi.ListResponseDataEntry);
    });
    ...
    it('should have the property telemetryId (base name: "telemetryId")', function() {
      ...
      //var instance = new TelemetryApi.ListResponseDataEntry();
