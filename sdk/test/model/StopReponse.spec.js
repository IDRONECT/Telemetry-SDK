...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelemetryApi.StopReponse();
  });
  ...
  describe('StopReponse', function() {
    it('should create an instance of StopReponse', function() {
      // uncomment below and update the code to test StopReponse
      //var instane = new TelemetryApi.StopReponse();
      //expect(instance).to.be.a(TelemetryApi.StopReponse);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new TelemetryApi.StopReponse();
