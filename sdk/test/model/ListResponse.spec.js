...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelemetryApi.ListResponse();
  });
  ...
  describe('ListResponse', function() {
    it('should create an instance of ListResponse', function() {
      ...
      //var instane = new TelemetryApi.ListResponse();
      //expect(instance).to.be.a(TelemetryApi.ListResponse);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new TelemetryApi.ListResponse();
